...
def test_lifecycle_migration_backfills_aware_and_naive_schedule_times(tmp_path):
    ...
    connection = ConnectionHandler(
        {
            "default": {
                ...
                "NAME": str(tmp_path / "lifecycle-migration.sqlite3"),
            },
        }
    )["default"]
    default_connection = connections["default"]
    # Historical model managers resolve the default alias through this handler.
