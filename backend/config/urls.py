...
from apps.workflows.api.views import (
    WorkflowDraftAnswerView,
    WorkflowDraftConfirmView,
...
urlpatterns = [
    ...
    path(
        "api/v1/workflow-drafts/<uuid:draft_id>/answers",
        WorkflowDraftAnswerView.as_view(),
        name="workflow-draft-answers",
    ),
    path(
