...
ASR_TIMEOUT_SECONDS = float(os.environ.get("ASR_TIMEOUT_SECONDS", "75"))
...
ASR_MAX_DURATION_SECONDS = float(os.environ.get("ASR_MAX_DURATION_SECONDS", "60"))
...
ASR_LEASE_TTL_SECONDS = int(os.environ.get("ASR_LEASE_TTL_SECONDS", "90"))
