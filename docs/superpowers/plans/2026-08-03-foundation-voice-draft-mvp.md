...
- [ ] **Step 1: Create the dependency and test configuration files**
...
- [ ] **Step 2: Install the backend development dependencies**
...
- [ ] **Step 5: Add the minimal Django configuration and health view**
...
- [ ] **Step 1: Write failing tests for the agreed voice example and ambiguity behavior**
...
- [ ] **Step 3: Implement strict Pydantic schemas and the minimal parser**
...
- [ ] **Step 1: Write a failing authenticated API test**
...
- [ ] **Step 3: Add transient session and draft models**
...
- [ ] **Step 4: Implement serializer and authenticated POST view**
...
- [ ] **Step 7: Commit draft persistence and API**
...
- [ ] **Step 3: Add the minimal reminder rule and transactional confirmation**
...
- [ ] **Step 4: Create migrations and verify GREEN**
...
- [ ] **Step 1: Create the Flutter project metadata**
...
- [ ] **Step 4: Implement the minimal domain model, HTTP client, and screen**
...
- [ ] **Step 6: Commit the Flutter foundation**
...
- [ ] **Step 1: Add container configuration**
...
- [ ] **Step 2: Add repeatable development commands**
...
- [ ] **Step 4: Document Mac-to-iPhone access**
...
- [ ] **Step 3: Run Flutter and Compose verification when tools exist**
...
- [ ] **Step 5: Update checklist and commit phase completion**
